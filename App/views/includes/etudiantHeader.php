...
<header>
    ...
    <nav>
        ...
        <ul class="hide-menu">
            ...
            <li id="addnews"><a href="<?= URLROOT . '/etudiants/dashboard' ?>"><i
                        class="fa-solid fa-graduation-cap"></i><span>Formations</span></a></li>
            <li id="paiment"><a href="<?= URLROOT . '/etudiants/watchedVideos' ?>"><i
                        class="fa-solid fa-check"></i><span>regardé</span></a></li>
            <li id="paiment"><a href="<?= URLROOT . '/etudiants/bockMarckedVideos' ?>"><i
                        class="far fas fa-bookmark"></i><span>Signets</span></a></li>
            <li id="statistics"><a href="<?= URLROOT . '/etudiants/updateInfos' ?>"><i
