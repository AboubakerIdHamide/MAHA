$(document).ready(function() {
    ...
    $videosList.on("click", function(event) {
        ...
        $(this).find("i.fa-circle-play").removeClass("fa-circle-play").addClass("fa-circle-pause");
    ...
    $btn.click(function(event) {
        ...
        const divComment = `
		<div class="d-flex gap-2 mt-2 ${$user_comment === "formateur" && "flex-row-reverse"}">
...
function likeToIt(idEtudiant, idFormation) {
    $.post(`${urlRoot}/ajax/likeToformation`, {
