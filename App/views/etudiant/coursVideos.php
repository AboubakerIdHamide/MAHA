...
<body>
                        ...
                        <ul>
                            ...
                            <li
                                ...
                                <div class="d-flex align-items-center"><i
                                        ...
                                        class="video-name"><?= $cpt++ . ". " . $video->nomVideo ?></span></div>
    ...
    <section class="container">
        <div class="row">
            <div class="col">
                <p class="desc"><?= $data->videos[0]->description ?></p>
            </div>
        </div>
        </div>
    </section>
            ...
            <div class="col">
                <div class="my-comments">
                    ...
                    <div
                        ...
                        <img class="align-self-start" src="<?= $comment->img ?>"
                            alt="my-photo">
                        <div
    ...
    const etudiantImageSrc = "<?= $data->imgEtudiant ?>";
    const etudiantFullName = "<?= $data->nomEtudiant . " " . $data->prenomEtudiant ?>";
