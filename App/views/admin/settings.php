        ...
        <div class="col">
            <form id="settings-form">
                ...
                <div class="mb-3">
                    ...
                    <input value="<?= $data->platform_pourcentage ?>" type="text" id="platform-pourcentage" name="platform_pourcentage" class="form-control" placeholder="Platform Pourcentage" required>
                </div>
                <div class="mb-3">
                    <label for="username-p" class="form-label">Username Paypal</label>
                    <input value="<?= $data->username_paypal ?>" type="text" id="username-p" name="username_p" class="form-control" placeholder="Username Paypal" required>
                </div>
                <div class="mb-3">
                    <label for="password-p" class="form-label">Password Paypal</label>
                    <input value="<?= $data->password_paypal ?>" type="text" id="password-p" name="password_p" class="form-control" placeholder="Password Paypal" required>
                </div>
