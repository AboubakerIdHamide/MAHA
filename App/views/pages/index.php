				...
				<div class="item">
					<div class="box_grid">
						...
						<ul>
							...
							<li><a href='<?php echo URLROOT . "/pageFormations/coursDetails/" . $course->IdFormation ?>'>Plus</a>
							</li>
						</ul>
					</div>
				</div>
...
<!-- /main -->
<div style="z-index: 999;" class="toast align-items-center p-1 border-0 bg-success text-white position-fixed bottom-0 end-0 me-3 mb-3" id="liveToast" role="alert" aria-live="assertive" aria-atomic="true">
	<div class="d-flex">
