				...
				<div class="container">
					<div class="row justify-content-center text-center">
						<div class="col-xl-8 col-lg-9">
							<h2>500 <i class="fa-solid fa-triangle-exclamation"></i></h2>
							<p class="error-message">Veuillez réessayer plus tard ou n'hésitez pas à nous contacter si le problème persiste.</p>
