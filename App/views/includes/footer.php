    ...
    <!-- COMMON SCRIPTS -->
    <script src="<?php echo URLROOT; ?>/public/jQuery/jquery-3.6.3.min.js"></script>
    <script src="<?php echo URLROOT; ?>/public/js/common_scripts.js"></script>
    <script src="<?php echo URLROOT; ?>/public/js/mainT.js"></script>
	<script src="<?php echo URLROOT; ?>/public/js/validate.js"></script>
