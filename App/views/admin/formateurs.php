                        ...
                        <?php foreach ($data['formateurs'] as $formateur) : ?>
                            <tr>
                                ...
                                <td class="d-flex gap-1" style="font-weight: 500;">
                                    <img style="width: 35px;" class="img-fluid rounded-circle avatar-formateur" src="<?= $formateur->img_formateur ?>" alt="formateur avatar">
                                ...
                                <td class="specialite-formateur" id="<?= $formateur->id_categorie ?>"><?= $formateur->nom_categorie ?></td>
...
<script src="<?php echo URLROOT; ?>/public/js/adminFormateurs.js"></script>
</body>
