...
<head>
    ...
    <title>Page expirée | <?= SITENAME ?></title>
    <!-- Font Icons -->
				...
				<div class="container">
					<div class="row justify-content-center text-center">
						<div class="col-xl-8 col-lg-9">
							<h2 class="text-uppercase">expiré <i class="fa-solid fa-triangle-exclamation"></i></h2>
							<p class="error-message">Désolé, votre token a expiré.</p>
