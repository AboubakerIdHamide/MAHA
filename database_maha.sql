...
INSERT IGNORE INTO `categories` (`id_categorie`, `nom_categorie`) VALUES
  (1, '3D'),
  (2, 'Architecture & BIM'),
  (3, 'Audio-MAO'),
...
-- Dumping data for table maha.etudiants: ~2 rows (approximately)
...
-- Dumping data for table maha.formateurs: ~2 rows (approximately)
...
INSERT IGNORE INTO `tablefilter` (`IdFormation`, `imgFormation`, `duree`, `idCategore`, `categorie`, `nomFormation`, `prix`, `description`, `likes`, `IdFormteur`, `nomFormateur`, `prenomFormateur`, `specialiteId`, `specialite`, `imgFormateur`, `numbAcht`, `dateCreationFormation`, `idLangage`, `langageFormation`, `idNiv`, `niveauFormation`) VALUES
  (1, '46425417951', '11:58:00', 5, 'Code', 'Cours Complet PHP et MYSQL', 45, 'Lorem ipsum dolor sit amet. Et internos dolores et inventore cupiditate ex dolorum officia sit facilis deserunt nam voluptas consequatur. Sit vitae similique et tempore eveniet qui minima deleniti. Id repudiandae quia ut ipsam galisum ut corporis autem.', 1, 0, 'Loream', 'Sbsia', 1, '3D', 'images/default.jpg', 0, '2022-12-25', 1, 'Français', 2, 'intermédiaire');
