				...
				<div class="card p-2">
					<div class="text-center">
						<div class="avatar-container">
							<img id="avatar-profil" src="<?php echo $data[0]['img']?>" alt="user image" >
							<div class="mt-2">
						...
						<h5 class="mt-2 nom-prenom" id='nom-prenom-aff'><?php echo $data[0]['nom']?> <?php echo $data[0]['prenom']?></h5>
						<p class="speciality-display" id='cat-aff'><?php echo $data[0]['categorie']?></p>
					...
					<div class="px-4">
						...
						<p class="bio-display" id='bio-aff'><?php echo $data[0]['bio']?></p>
					</div>
				</div>
			</div>
					...
					<div class="card-body">
							...
							<div class="col-md-6 col-12">
								...
								<div class="input-group flex-nowrap">
									<input type="text" class="form-control" aria-label="nom"
										aria-describedby="addon-wrapping" value="<?php echo $data[0]['nom']?>" disabled id="nom">
									<span class="input-group-text" id="nom-icon"><i
											class="fa-solid fa-pen-to-square"></i></span>
								</div>
								<small id="error-nom" class="error text-danger"><?php echo $data[0]['nom_err']?></small>
							</div>
							<div class="col mt-3 mt-md-0">
								<label for="prenom" class="form-label">Prénom</label>
								<div class="input-group flex-nowrap">
									<input value="<?php echo $data[0]['prenom']?>" type="text" class="form-control" aria-label="prenom"
										aria-describedby="addon-wrapping" id="prenom" disabled>
									<span class="input-group-text" id="prenom-icon"><i
											class="fa-solid fa-pen-to-square"></i></span>
								</div>
								<small id="error-prenom" class="error text-danger"><?php echo $data[0]['prenom_err']?></small>
							</div>
						</div>
						<div class="row mt-3">
							<div class="col">
								...
								<div class="input-group flex-nowrap">
									<input type="email" class="form-control" id="email" value="<?php echo $data[0]['email']?>" disabled>
								</div>
						...
						<div class="row mt-3">
							<div class="col">
								...
								<div class="input-group flex-nowrap">
									<input value="<?php echo $data[0]['tel']?>" type="text" class="form-control"
										aria-label="Numero Telephone" aria-describedby="addon-wrapping" id="tele"
										disabled>
									<span class="input-group-text" id="phone-icon"><i
											class="fa-solid fa-pen-to-square"></i></span>
								</div>
								<small class="error text-danger" id="error-tele"><?php echo $data[0]['tel_err']?></small>
							</div>
						</div>
						<div class="row mt-3">
							<div class="col">
							...
							<div class="col">
								...
								<select id="spec" class="form-select" aria-label="Default select example">
                                    ...
                                    foreach($data[1] as $cat){
										if($cat->id_categorie == $data[0]['specId']){
								...
								<small class="error text-danger" id="error-spec"><?php echo $data[0]['specId_err']?></small>
							</div>
						</div>
						<div class="row mt-3">
							<div class="col">
								...
								<textarea id="bio" class="form-control" rows="3"
									disabled><?php echo $data[0]['bio']?></textarea>
								<small id="error-bio" class="error text-danger"><?php echo $data[0]['bio_err']?></small>
							</div>
						</div>
						<div class="row mt-3">
							<div class="col">
