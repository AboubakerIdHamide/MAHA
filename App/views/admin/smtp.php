        ...
        <div class="col">
            <form id="smtp-form">
                ...
                <div class="mb-3">
                    ...
                    <input value="<?= $data['host'] ?? '' ?>" type="text" id="host" name="host" class="form-control"
                        placeholder="Host" required>
                </div>
                <div class="mb-3">
                    <label for="username" class="form-label">Username</label>
                    <input value="<?= $data['username'] ?? '' ?>" type="text" id="username" name="username"
                        class="form-control" placeholder="Username" required>
                </div>
                <div class="mb-3">
                    <label for="password" class="form-label">Password</label>
                    <input value="<?= $data['password'] ?? '' ?>" type="text" id="password" name="password"
                        class="form-control" placeholder="Password" required>
                </div>
                <div class="mb-3">
                    <label for="port" class="form-label">Port</label>
                    <input value="<?= $data['port'] ?? '' ?>" type="number" id="port" name="port" class="form-control"
